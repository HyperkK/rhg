...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlCDjpHU7TVl4QvaS3wqYIWpvLum15W57eP2viHlapUaXVF5ghXfKnmCev0WUPEquNAEWx4iEPsG47XVJOumRKYDnORAe+2PtbcWBk7Z8Ye61gGXrw==
##Kc/BRM3KXhU=
##
##
...
$image1.image = [system.drawing.image]::FromFile("E:\Canard Titan Remasterized\Content\CNR_Picture_loading_phase_start.png")
